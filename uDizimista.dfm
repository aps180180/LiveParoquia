object fDizimista: TfDizimista
  Left = 196
  Top = 114
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'fDizimista-CADASTRO DE DIZIMISTAS'
  ClientHeight = 432
  ClientWidth = 649
  Color = clBtnFace
  ...
  object GroupBox1: TspSkinGroupBox
    ...
    object BbeTelefone: TspSkinDBEdit
      Left = 40
      Top = 209
      Width = 82
      Height = 18
    ...
    object DbeCelular: TspSkinDBEdit
      Left = 125
      Top = 209
      Width = 82
      Height = 18
    ...
    object RadioGroup: TspSkinDBRadioGroup
      Left = 110
      Top = 26
      Width = 189
      Height = 43
    ...
    object dbeComunidade: TspSkinDBEdit
      Left = 40
      Top = 249
      Width = 33
      Height = 18
    ...
    object dbeDiaDoacao: TspSkinDBComboBox
      Left = 418
      Top = 208
      Width = 41
      Height = 20
    ...
    object spSkinLabel15: TspSkinLabel
      ...
      BorderStyle = bvFrame
      Alignment = taCenter
      Caption = 'Ultima Oferta'
      AutoSize = False
    end
    object edit3: TspSkinEdit
      Left = 492
      Top = 292
      Width = 71
      Height = 18
    ...
    object rgCampanha: TspSkinDBRadioGroup
      ...
      RollUpMode = False
      RollUpState = False
      Caption = 'Dizimista de Campanha'
      Columns = 2
      DataField = 'DIZIMISTA_CAMPANHA'
      DataSource = DsDizimista
      Items.Strings = (
        'Sim'
        'N'#227'o')
  ...
  object btCancelar: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Cancelar inclus'#227'o da Dizimista'
    HintImageIndex = 0
    TabOrder = 4
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object btSair: TspSkinButton
    ...
    Width = 105
    Height = 39
    Hint = 'Sair do cadastro de Dizimista'
    HintImageIndex = 0
    TabOrder = 6
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object DsDizimista: TDataSource
    DataSet = DM1.TDizimista
    OnStateChange = DsDizimistaStateChange
    Left = 568
    Top = 40
  end
  object ibUltimaOferta: TIBQuery
    Database = dmDados.db
    Transaction = dmDados.Transacao
    OnCalcFields = ibUltimaOfertaCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT FIRST 1 MES, ANO, VALOR   FROM DIZIMO'
    ...
    object ibUltimaOfertaMES: TIBStringField
      FieldName = 'MES'
      Origin = '"DIZIMO"."MES"'
      FixedChar = True
      Size = 2
    end
    object ibUltimaOfertaANO: TIBStringField
      FieldName = 'ANO'
      Origin = '"DIZIMO"."ANO"'
      Size = 4
    end
    object ibUltimaOfertaVALOR: TIBBCDField
      FieldName = 'VALOR'
      Origin = '"DIZIMO"."VALOR"'
      Precision = 18
      Size = 2
    end
    object ibUltimaOfertasMesAno: TStringField
