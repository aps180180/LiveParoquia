object fBatizados: TfBatizados
  Left = 192
  Top = 114
  Align = alCustom
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'fBatizados-CADASTRO DE BATIZANDOS'
  ClientHeight = 395
  ClientWidth = 682
  Color = clBtnFace
  ...
  object DsBatizados: TDataSource
    DataSet = DM1.TBatizados
    OnStateChange = DsBatizadosStateChange
    Left = 616
    Top = 112
  end
