object fCrisma: TfCrisma
  Left = 159
  Top = 98
  AutoScroll = False
  BorderIcons = []
  Caption = 'fCrisma-LAN'#199'AMENTO DE CRISMAS'
  ClientHeight = 459
  ClientWidth = 804
  Color = clBtnFace
  ...
  object btCancelar: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Cancelar inclus'#227'o da Crisma.'
    HintImageIndex = 0
    TabOrder = 4
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object btSair: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Sair do cadastro de Crisma.'
    HintImageIndex = 0
    TabOrder = 6
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object GroupBox1: TspSkinGroupBox
    ...
    object spSkinLabel2: TspSkinLabel
      ...
      UseSkinFontColor = True
      BorderStyle = bvFrame
      Caption = 'Nome Crismando'
      AutoSize = True
    end
    object dbeNomeCrismando: TspSkinDBEdit
      Left = 138
      Top = 90
      Width = 368
      Height = 18
      Text = 'DBENOMECRISMANDO'
    ...
    object spSkinLabel5: TspSkinLabel
      ...
      UseSkinFontColor = True
      BorderStyle = bvFrame
      Caption = 'C'#243'd. Crismando'
      AutoSize = True
    end
    object dbeCodCrismando: TspSkinDBEdit
      Left = 56
      Top = 90
      Width = 75
      Height = 18
      Text = 'DBECODCRISMANDO'
      DefaultColor = clWindow
      DefaultFont.Charset = DEFAULT_CHARSET
      DefaultFont.Color = clBlack
      DefaultFont.Height = 14
      ...
      RightImageHotIndex = -1
      RightImageDownIndex = -1
      OnButtonClick = dbeCodCrismandoButtonClick
      OnEnter = dbeCodCrismandoEnter
      OnExit = dbeCodCrismandoExit
      OnKeyDown = dbeCodCrismandoKeyDown
      AutoSize = False
      DataField = 'CODCRISMANDO'
      DataSource = dsCrisma
    end
    ...
    object dbeDtCrisma: TspSkinDBEdit
      Left = 431
      Top = 129
      Width = 77
      Height = 18
  ...
  object btImprimir: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Imprimir a Certid'#227'o de Crisma'
    HintImageIndex = 0
    TabOrder = 8
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object dsCrisma: TDataSource
    DataSet = DM1.TCrisma
    OnStateChange = dsCrismaStateChange
    Left = 720
    Top = 32
  end
  ...
  object ppRepCrisma: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel5: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'CERTID'#195'O DE CRISMA'
      ...
      object ppLabel6: TppLabel
        ...
        Border.Visible = False
        Caption = 
          'Certifico que, revendo os livros de assentamentos de Crismas des' +
          'ta par'#243'quia'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
