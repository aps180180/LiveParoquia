object fMinistrosPadres: TfMinistrosPadres
  Left = 192
  Top = 114
  AutoScroll = False
  BorderIcons = []
  Caption = 'fMinistrosPadres-CADASTRO DE MINISTROS E PADRES'
  ClientHeight = 291
  ClientWidth = 688
  Color = clBtnFace
  ...
  object DsMinistrosPadres: TDataSource
    DataSet = DM1.TMinistrosPadres
    OnStateChange = DsMinistrosPadresStateChange
    Left = 632
    Top = 8
  end
end
