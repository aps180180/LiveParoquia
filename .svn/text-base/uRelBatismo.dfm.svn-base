object fRelBatismo: TfRelBatismo
  Left = 162
  Top = 201
  AutoScroll = False
  BorderIcons = []
  Caption = 'fRelBatismo-RELA'#199#195'O DE BATISMOS'
  ClientHeight = 240
  ClientWidth = 434
  Color = clBtnFace
  ...
  object DsRelBatismo: TDataSource
    DataSet = qryConsulta
    Left = 400
    Top = 104
  end
  ...
  object qryConsulta: TIBQuery
    ...
    object qryConsultaCODBATIZANDO: TIntegerField
      FieldName = 'CODBATIZANDO'
      Origin = 'BATISTERIO.CODBATIZANDO'
    end
    object qryConsultaNOMEBATIZANDO: TIBStringField
      FieldName = 'NOMEBATIZANDO'
      Origin = 'BATISTERIO.NOMEBATIZANDO'
      Size = 60
    end
    object qryConsultaDTNASC: TDateField
      FieldName = 'DTNASC'
      Origin = 'BATISTERIO.DTNASC'
    end
    object qryConsultaNATURALIDADE: TIBStringField
      FieldName = 'NATURALIDADE'
      Origin = 'BATISTERIO.NATURALIDADE'
      Size = 60
    end
    object qryConsultaPAI: TIBStringField
      FieldName = 'PAI'
      Origin = 'BATISTERIO.PAI'
      Size = 60
    end
    object qryConsultaMAE: TIBStringField
      FieldName = 'MAE'
      Origin = 'BATISTERIO.MAE'
      Size = 60
    end
    object qryConsultaPADRINHO: TIBStringField
      FieldName = 'PADRINHO'
      Origin = 'BATISTERIO.PADRINHO'
      Size = 60
    end
    object qryConsultaMADRINHA: TIBStringField
      FieldName = 'MADRINHA'
      Origin = 'BATISTERIO.MADRINHA'
      Size = 60
    end
    object qryConsultaDTBATISMO: TDateField
      FieldName = 'DTBATISMO'
      Origin = 'BATISTERIO.DTBATISMO'
    end
    object qryConsultaPADRE: TIntegerField
      FieldName = 'PADRE'
      Origin = 'BATISTERIO.PADRE'
    end
    object qryConsultaCOMUNIDADE: TIntegerField
      FieldName = 'COMUNIDADE'
  ...
  object ppRepRelBatismo: TppReport
    AutoStop = False
