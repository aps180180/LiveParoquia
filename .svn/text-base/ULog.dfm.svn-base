object fLog: TfLog
  ...
  AutoScroll = False
  BorderIcons = []
  Caption = 'fLog-Auditoria de Opera'#231#245'es'
  ClientHeight = 289
  ClientWidth = 284
  Color = clBtnFace
  ...
  object qryConsultaLog: TIBQuery
    Database = dmDados.db
    Transaction = dmDados.Transacao
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT* FROM LOG WHERE PAROQUIA=:pPAROQUIA ')
    Left = 72
    Top = 8
    ParamData = <
      item
    ...
    object qryConsultaLogFORMULARIO: TIBStringField
      FieldName = 'FORMULARIO'
      Origin = 'LOG.FORMULARIO'
    end
    object qryConsultaLogACAO: TIBStringField
      DisplayWidth = 59
      FieldName = 'ACAO'
      Origin = 'LOG.ACAO'
      Size = 250
    end
    object qryConsultaLogDATA: TDateTimeField
      FieldName = 'DATA'
      Origin = 'LOG.DATA'
    end
    object qryConsultaLogUSUARIONOME: TIBStringField
      FieldName = 'USUARIONOME'
      Origin = 'LOG.USUARIONOME'
    end
    object qryConsultaLogID: TIntegerField
      FieldName = 'ID'
      Origin = 'LOG.ID'
      Required = True
    end
    object qryConsultaLogUSUARIO: TIntegerField
      FieldName = 'USUARIO'
      Origin = 'LOG.USUARIO'
    end
    object qryConsultaLogCOMPUTADOR: TIBStringField
      FieldName = 'COMPUTADOR'
      Origin = 'LOG.COMPUTADOR'
      Size = 30
    end
    object qryConsultaLogPAROQUIA: TIntegerField
      FieldName = 'PAROQUIA'
      Origin = 'LOG.PAROQUIA'
      Required = True
    end
  end
  object dsConsultaLog: TDataSource
    DataSet = qryConsultaLog
    Left = 104
    Top = 8
  end
  object ppDBPipeline1: TppDBPipeline
    DataSource = dsConsultaLog
    UserName = 'DBPipeline1'
    Left = 136
    Top = 8
    object ppDBPipeline1ppField1: TppField
      FieldAlias = 'FORMULARIO'
      FieldName = 'FORMULARIO'
      FieldLength = 20
      DisplayWidth = 20
      Position = 0
  ...
  object ppRepLog: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel5: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Auditoria de Opera'#231#245'es'
      ...
      object ppLabel8: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Data/Hora da Opera'#231#227'o'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
