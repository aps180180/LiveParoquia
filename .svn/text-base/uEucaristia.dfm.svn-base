object fEucaristia: TfEucaristia
  Left = 192
  Top = 114
  Align = alCustom
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'fEucaristia-CADASTRO DE 1'#170' EUCARISTIA'
  ClientHeight = 395
  ClientWidth = 682
  Color = clBtnFace
  ...
  object DsEucaristia: TDataSource
    DataSet = DM1.TEucaristia
    OnStateChange = DsEucaristiaStateChange
    Left = 616
    Top = 112
  end
