object fIntencoesMissas: TfIntencoesMissas
  Left = 193
  Top = 159
  AutoScroll = False
  BorderIcons = []
  Caption = 'fIntencoesMissas-INTEN'#199'OES DE MISSAS'
  ClientHeight = 285
  ClientWidth = 688
  Color = clBtnFace
  ...
  object DsIntencoesMissas: TDataSource
    DataSet = DM1.TintencoesMissas
    OnStateChange = DsIntencoesMissasStateChange
    Left = 632
    Top = 8
  end
end
