object fLancCaixa: TfLancCaixa
  Left = 54
  Top = 109
  AutoScroll = False
  BorderIcons = []
  Caption = 'fLancamentoCaixa - LAN'#199'AMENTO DE CAIXA'
  ClientHeight = 420
  ClientWidth = 804
  Color = clBtnFace
  ...
  object GroupBox1: TspSkinGroupBox
    ...
    object dbeHistorico: TspSkinDBMemo
      Left = 56
      Top = 252
      Width = 658
      Height = 58
    ...
    object DBETIPOMOV: TspSkinDBEdit
      Left = 58
      Top = 171
      Width = 28
      Height = 18
      ...
      RightImageHotIndex = -1
      RightImageDownIndex = -1
      OnEnter = DBETIPOMOVEnter
      OnExit = DBETIPOMOVExit
      OnKeyDown = DBETIPOMOVKeyDown
      AutoSize = False
      DataField = 'TIPOMOV'
      DataSource = dsLancCaixa
    end
    ...
    object DBEVALORMOV: TspSkinDBEdit
      Left = 58
      Top = 212
      Width = 77
      Height = 18
  ...
  object dsLancCaixa: TDataSource
    DataSet = DM1.tCaixa
    OnStateChange = dsLancCaixaStateChange
    Left = 640
    Top = 8
  end
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select sum(valormov)valormov  from movcaixa left join tipopgto o' +
        'n movcaixa.tipomov=tipopgto.codigo where  tipopgto.tipooperacao=' +
        #39'C'#39' and tipopgto.codigo=:pTipoCodigo and tipopgto.paroquia=:ppar' +
        'oquia')
    Left = 608
    Top = 104
    ParamData = <
    ...
    object IBQuery1VALORMOV: TIBBCDField
      FieldName = 'VALORMOV'
      Precision = 18
      Size = 2
    end
