object fRelPeriodico: TfRelPeriodico
  Left = 269
  Top = 282
  AutoScroll = False
  BorderIcons = []
  Caption = 'fRelPeriodico - Relat'#243'rio Peri'#243'dico de D'#237'zimos/Ofertas'
  ClientHeight = 190
  ClientWidth = 435
  Color = clBtnFace
  ...
  object IBRelatorio: TIBQuery
    ...
    OnCalcFields = IBRelatorioCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'SELECT DIZIMO.*,  DIZIMISTA.DIZIMISTA AS NOME  ,COMUNIDADE.COMUN' +
        'IDADE'
      
        'FROM DIZIMO LEFT JOIN DIZIMISTA ON DIZIMO.PAROQUIA=DIZIMISTA.PAR' +
        'OQUIA'
      'AND DIZIMO.DIZIMISTA=DIZIMISTA.CODIGO'
      
        'LEFT JOIN COMUNIDADE ON DIZIMISTA.PAROQUIA=COMUNIDADE.PAROQUIA A' +
        'ND'
      'DIZIMISTA.COMUNIDADE=COMUNIDADE.CODIGO'
      ''
      'WHERE DIZIMO.PAROQUIA= :PPAROQUIA'
      'AND DIZIMISTA.COMUNIDADE= :PCOMUNIDADE')
    Left = 392
    Top = 48
    ParamData = <
      item
    ...
    object IBRelatorioMES: TIBStringField
      FieldName = 'MES'
      Origin = '"DIZIMO"."MES"'
      FixedChar = True
      Size = 2
    end
    object IBRelatorioDIZIMISTA: TIntegerField
      FieldName = 'DIZIMISTA'
      Origin = '"DIZIMO"."DIZIMISTA"'
    end
    object IBRelatorioDATA: TDateField
      FieldName = 'DATA'
      Origin = '"DIZIMO"."DATA"'
    end
    ...
    object IBRelatorioPERIODO: TIBStringField
      FieldName = 'PERIODO'
      Origin = '"DIZIMO"."PERIODO"'
    end
    object IBRelatorioANO: TIBStringField
      FieldName = 'ANO'
      Origin = '"DIZIMO"."ANO"'
      Size = 4
    end
    object IBRelatorioORIGEM: TIntegerField
      FieldName = 'ORIGEM'
      Origin = '"DIZIMO"."ORIGEM"'
    end
    object IBRelatorioTOTPERIODO: TIBBCDField
      FieldName = 'TOTPERIODO'
      Origin = '"DIZIMO"."TOTPERIODO"'
      Precision = 18
      Size = 2
    end
    object IBRelatorioNOME: TIBStringField
      FieldName = 'NOME'
      Origin = '"DIZIMISTA"."DIZIMISTA"'
      Size = 60
    end
    object IBRelatorioCOMUNIDADE: TIBStringField
      FieldName = 'COMUNIDADE'
      Origin = '"COMUNIDADE"."COMUNIDADE"'
      Size = 60
    end
    object IBRelatoriosMesAno: TStringField
  ...
  object ppRepPeriodico: TppReport
    AutoStop = False
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel5: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'RELAT'#211'RIO PERI'#211'DICO DE D'#205'ZIMOS/OFERTAS'
