object fCatequista: TfCatequista
  Left = 192
  Top = 114
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'fCatequista-CADASTRO DE CATEQUISTAS'
  ClientHeight = 248
  ClientWidth = 688
  Color = clBtnFace
  ...
  object GroupBox1: TspSkinGroupBox
    ...
    object dbeComunidade: TspSkinDBEdit
      ...
      RightImageHotIndex = -1
      RightImageDownIndex = -1
      OnButtonClick = dbeComunidadeButtonClick
  ...
  object dsCatequista: TDataSource
    DataSet = DM1.TCatequista
    OnStateChange = dsCatequistaStateChange
    Left = 584
    Top = 40
  end
