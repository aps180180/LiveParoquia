object fTipoPgto: TfTipoPgto
  Left = 192
  Top = 107
  AutoScroll = False
  BorderIcons = []
  Caption = 'fTipoPgto-CADASTRO DE TIPOS DE PAGAMENTOS'
  ClientHeight = 276
  ClientWidth = 688
  Color = clBtnFace
  ...
  object GroupBox1: TspSkinGroupBox
    ...
    object RadioGroup1: TspSkinDBRadioGroup
      Left = 328
      Top = 48
      Width = 150
      Height = 65
  ...
  object btCancelar: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Cancelar o cadastro do Tipo Pagamento'
    HintImageIndex = 0
    TabOrder = 4
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object btSair: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Sair do cadastro de Tipo de Pagamento'
    HintImageIndex = 0
    TabOrder = 6
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object DsTipoPgto: TDataSource
    DataSet = DM1.TTipoPgto
    OnStateChange = DsTipoPgtoStateChange
    Left = 632
    Top = 56
  end
