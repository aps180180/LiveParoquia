object fArquidiocese: TfArquidiocese
  Left = 192
  Top = 114
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = 'fArquidiocese-CADASTRO DE ARQUIDIOCESE'
  ClientHeight = 257
  ClientWidth = 682
  Color = clBtnFace
  ...
  object DsArquidiocese: TDataSource
    DataSet = DM1.TArquidiocese
    OnStateChange = DsArquidioceseStateChange
    Left = 632
    Top = 48
  end
