object fParoquias: TfParoquias
  Left = 193
  Top = 160
  Align = alCustom
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'fParoquias - CADASTRO DE PAR'#211'QUIAS'
  ClientHeight = 329
  ClientWidth = 687
  Color = clBtnFace
  ...
  object GroupBox1: TspSkinGroupBox
    ...
    object DbeTelefone: TspSkinDBEdit
      Left = 80
      Top = 172
      Width = 82
      Height = 18
    ...
    object dbeArquidiocese: TspSkinDBEdit
      Left = 16
      Top = 215
      Width = 28
      Height = 18
      Text = 'DBEARQUIDIOCESE'
      DefaultColor = clWindow
      DefaultFont.Charset = DEFAULT_CHARSET
      DefaultFont.Color = clBlack
      DefaultFont.Height = 14
      ...
      RightImageHotIndex = -1
      RightImageDownIndex = -1
      OnEnter = dbeArquidioceseEnter
      OnExit = dbeArquidioceseExit
      OnKeyDown = dbeArquidioceseKeyDown
      AutoSize = False
      DataField = 'ARQUIDIOCESE'
      DataSource = dsParoquias
    end
  ...
  object btCancelar: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Cancelar inclus'#227'o da Par'#243'quia.'
    HintImageIndex = 0
    TabOrder = 4
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object btSair: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Sair do cadastro de Par'#243'quia.'
    HintImageIndex = 0
    TabOrder = 6
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object dsParoquias: TDataSource
    DataSet = DM1.TPAROQUIA
    OnStateChange = dsParoquiasStateChange
    Left = 600
    Top = 49
  end
end
