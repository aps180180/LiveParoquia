object fMatrimonio: TfMatrimonio
  Left = 189
  Top = 83
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = 'fMatrimonio-LAN'#199'AMENTO MATRIM'#212'NIO SIMPLIFICADO'
  ClientHeight = 473
  ClientWidth = 800
  Color = clBtnFace
  ...
  object btCancelar: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Cancelar inclus'#227'o do Matrim'#244'nio.'
    HintImageIndex = 0
    TabOrder = 3
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object btImprimir: TspSkinButton
    ...
    Width = 113
    Height = 39
    Hint = 'Imprimir a Certid'#227'o do Matrim'#244'nio'
    HintImageIndex = 0
    TabOrder = 7
    DrawDefault = True
    SkinData = fPrincipal.spSkinData1
  ...
  object PageControl1: TspSkinPageControl
    Left = 1
    Top = 7
    Width = 791
    Height = 378
    ...
    SkinData = fPrincipal.spSkinData1
    SkinDataName = 'tab'
    object TabSheet1: TspSkinTabSheet
      Caption = 'Geral'
      object GroupBox1: TspSkinGroupBox
        ...
        object spSkinLabel2: TspSkinLabel
          ...
          UseSkinFontColor = True
          BorderStyle = bvFrame
          Caption = 'Testemunha Qualificada'
          AutoSize = True
        end
        ...
        object dbeNumero: TspSkinDBEdit
          Left = 188
          Top = 110
          Width = 42
          Height = 18
        ...
        object dbeDtBatismo: TspSkinDBEdit
          Left = 239
          Top = 110
          Width = 86
          Height = 18
          ...
          RightImageHotIndex = -1
          RightImageDownIndex = -1
          OnExit = dbeDtBatismoExit
          AutoSize = False
          DataField = 'DTCELEBRACAO'
          DataSource = dsMatrimonio
        end
        object spSkinDBEdit5: TspSkinDBEdit
          Left = 237
          Top = 160
          Width = 200
          Height = 18
        ...
        object spSkinDBEdit4: TspSkinDBEdit
          Left = 445
          Top = 160
          Width = 204
          Height = 18
        ...
        object DbeNomeArquidiocese: TspSkinDBEdit
          Left = 357
          Top = 200
          Width = 292
          Height = 18
          Text = 'DBENOMEARQUIDIOCESE'
          DefaultColor = clWindow
          DefaultFont.Charset = DEFAULT_CHARSET
          DefaultFont.Color = clBlack
          DefaultFont.Height = 14
        ...
        object spSkinLabel4: TspSkinLabel
          ...
          UseSkinFontColor = True
          BorderStyle = bvFrame
          Caption = 'Lugar da Celebra'#231#227'o'
          AutoSize = True
        end
        ...
        object spSkinDBEdit6: TspSkinDBEdit
          Left = 30
          Top = 248
          Width = 324
          Height = 18
    ...
    object TabSheet2: TspSkinTabSheet
      Caption = 'Noivo'
      object GroupBox2: TspSkinGroupBox
        ...
        object dbeNoivo: TspSkinDBEdit
          ...
          RightImageHotIndex = -1
          RightImageDownIndex = -1
          OnEnter = dbeNoivoEnter
          OnExit = dbeNoivoExit
          OnKeyDown = dbeNoivoKeyDown
          AutoSize = False
          DataField = 'CODIGONOIVO'
          DataSource = dsMatrimonio
        end
        ...
        object DbeNatNoivo: TspSkinDBEdit
          Left = 193
          Top = 110
          Width = 344
          Height = 18
        ...
        object DbeEndNoivo: TspSkinDBEdit
          Left = 193
          Top = 162
          Width = 400
          Height = 18
        ...
        object DbePaiNoivo: TspSkinDBEdit
          Left = 193
          Top = 254
          Width = 400
          Height = 18
        ...
        object DbeCidadeNoivo: TspSkinDBEdit
          Left = 193
          Top = 210
          Width = 344
          Height = 18
        ...
        object DbeMaeNoivo: TspSkinDBEdit
          Left = 193
          Top = 302
          Width = 400
          Height = 18
          ...
          RightImageHotIndex = -1
          RightImageDownIndex = -1
          OnExit = DbeMaeNoivoExit
          AutoSize = False
          DataField = 'MAENOIVO'
          DataSource = dsMatrimonio
        end
        object DbeUfNatNoivo: TspSkinDBEdit
          Left = 546
          Top = 110
          Width = 48
          Height = 18
          ...
          RightImageHotIndex = -1
          RightImageDownIndex = -1
          OnExit = DbeUfNatNoivoExit
          AutoSize = False
          DataField = 'NATURALIDADE_UF_NOIVO'
          DataSource = dsMatrimonio
        end
        ...
        object DbeDtNascNoivo: TspSkinDBEdit
          Left = 504
          Top = 58
          Width = 90
          Height = 18
          ...
          RightImageDownIndex = -1
          AutoSize = False
          DataField = 'DTNASCNOIVO'
          DataSource = dsMatrimonio
        end
        object DbeUfEndNoivo: TspSkinDBEdit
          Left = 546
          Top = 210
          Width = 48
          Height = 18
        ...
        object spSkinLabel31: TspSkinLabel
          Left = 265
          Top = 36
          Width = 31
          Height = 16
        ...
        object DbeNomeNoivo: TspSkinDBEdit
          Left = 264
          Top = 58
          Width = 233
          Height = 18
    ...
    object TabSheet3: TspSkinTabSheet
      Caption = 'Noiva'
      object GroupBox3: TspSkinGroupBox
        Left = 0
        Top = 0
        Width = 769
        Height = 378
        ...
        object DbeNatNoiva: TspSkinDBEdit
          Left = 193
          Top = 103
          Width = 344
          Height = 18
        ...
        object spSkinDBEdit9: TspSkinDBEdit
          Left = 546
          Top = 103
          Width = 48
          Height = 18
          ...
          RightImageHotIndex = -1
          RightImageDownIndex = -1
          OnExit = spSkinDBEdit9Exit
          AutoSize = False
          DataField = 'NATURALIDADE_UF_NOIVA'
          DataSource = dsMatrimonio
        end
        object spSkinLabel26: TspSkinLabel
          Left = 193
          Top = 131
          Width = 65
          Height = 14
        ...
        object DbeEndNoiva: TspSkinDBEdit
          Left = 193
          Top = 151
          Width = 400
          Height = 18
        ...
        object spSkinLabel27: TspSkinLabel
          Left = 193
          Top = 178
          Width = 37
          Height = 14
        ...
        object DbeCidadeNoiva: TspSkinDBEdit
          Left = 193
          Top = 199
          Width = 344
          Height = 18
          ...
          RightImageDownIndex = -1
          AutoSize = False
          DataField = 'CIADADENOIVA'
          DataSource = dsMatrimonio
        end
        object spSkinLabel28: TspSkinLabel
          Left = 546
          Top = 178
          Width = 15
          Height = 14
        ...
        object DbeUfEndNoiva: TspSkinDBEdit
          Left = 546
          Top = 199
          Width = 47
          Height = 18
          ...
          RightImageDownIndex = -1
          AutoSize = False
          DataField = 'UF_END_NOIVA'
          DataSource = dsMatrimonio
        end
        object spSkinLabel29: TspSkinLabel
          Left = 193
          Top = 228
          Width = 18
          Height = 14
        ...
        object DbePaiNoiva: TspSkinDBEdit
          Left = 193
          Top = 248
          Width = 400
          Height = 18
        ...
        object spSkinLabel30: TspSkinLabel
          Left = 193
          Top = 274
          Width = 24
          Height = 14
        ...
        object DbeMaeNoiva: TspSkinDBEdit
          Left = 193
          Top = 292
          Width = 400
          Height = 18
          ...
          RightImageHotIndex = -1
          RightImageDownIndex = -1
          OnExit = DbeMaeNoivaExit
          AutoSize = False
          DataField = 'MAENOIVA'
          DataSource = dsMatrimonio
        end
        object DbeDtNascNoiva: TspSkinDBEdit
          Left = 504
          Top = 60
          Width = 89
          Height = 18
          ...
          RightImageDownIndex = -1
          AutoSize = False
          DataField = 'DTNASCNOIVA'
          DataSource = dsMatrimonio
        end
        object DbeNomeNoiva: TspSkinDBEdit
          Left = 192
          Top = 60
          Width = 305
          Height = 18
  ...
  object dsMatrimonio: TDataSource
    DataSet = DM1.TMatrimonio
    OnStateChange = dsMatrimonioStateChange
    Left = 648
    Top = 72
  end
  ...
  object ppRepMatrimonio: TppReport
    AutoStop = False
    DataPipeline = ppDBPipeline1
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Certidao Matrimonio-SoftLive'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel5: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'CERTID'#195'O DE MATRIM'#212'NIO'
      ...
      object ppLabel8: TppLabel
        ...
        Border.Visible = False
        Caption = 
          'Depois de efetuados os proclamas e demais formalidades prescrita' +
          's,n'#227'o aparecendo'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
      ...
      object ppLabel10: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'na presen'#231'a da testemunha qualificada:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
      ...
      object ppLabel15: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'receberam em Matrim'#244'nio'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
      ...
      object ppLabel22: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Para constar mandei lavrar essa certid'#227'o que assino.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 9
      ...
      object ppLblDtCelebracao: TppLabel
        UserName = 'LblDtCelebracao'
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'LblDtCelebracao'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
      ...
      object ppLblCidadeUfNoivo: TppLabel
        UserName = 'LblCidadeUfNoivo'
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
        Border.Visible = False
      ...
      object ppLblCidadeUfNoiva: TppLabel
        UserName = 'LblCidadeUfNoiva'
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
        Border.Visible = False
