object fLancIntencoes: TfLancIntencoes
  Left = 159
  Top = 98
  AutoScroll = False
  BorderIcons = []
  Caption = 'fLancamentoIntencoes - LAN'#199'AMENTO DE INTEN'#199#213'ES DE MISSAS'
  ClientHeight = 420
  ClientWidth = 687
  Color = clBtnFace
  ...
  object GroupBox1: TspSkinGroupBox
    ...
    object dbeDtCelebracao: TspSkinDBEdit
      Left = 57
      Top = 130
      Width = 77
      Height = 18
      Text = 'DBEDTCELEBRACAO'
    ...
    object spSkinLabel12: TspSkinLabel
      ...
      UseSkinFontColor = True
      BorderStyle = bvFrame
      Caption = 'Hora Celebra'#231#227'o'
      AutoSize = True
    end
    object dbHoraCelebracao: TspSkinDBEdit
      Left = 137
      Top = 130
      Width = 40
      Height = 18
      Text = 'DBHORACELEBRACAO'
      DefaultColor = clWindow
      DefaultFont.Charset = DEFAULT_CHARSET
      DefaultFont.Color = clBlack
      DefaultFont.Height = 14
    ...
    object spSkinLabel4: TspSkinLabel
      ...
      UseSkinFontColor = True
      BorderStyle = bvFrame
      Caption = 'Tipo Inten'#231#227'o'
      AutoSize = True
    end
    object dbeTipoIntencao: TspSkinDBEdit
      Left = 57
      Top = 170
      Width = 28
      Height = 18
      Text = 'DBETIPOINTENCAO'
      DefaultColor = clWindow
      DefaultFont.Charset = DEFAULT_CHARSET
      DefaultFont.Color = clBlack
      DefaultFont.Height = 14
      ...
      RightImageHotIndex = -1
      RightImageDownIndex = -1
      OnEnter = dbeTipoIntencaoEnter
      OnExit = dbeTipoIntencaoExit
      OnKeyDown = dbeTipoIntencaoKeyDown
      AutoSize = False
      DataField = 'TIPOINTENCAO'
      DataSource = dsLancIntencoes
    end
    ...
    object dbeCelebrante: TspSkinDBEdit
      Left = 57
      Top = 211
      Width = 368
      Height = 18
  ...
  object dsLancIntencoes: TDataSource
    DataSet = DM1.TLancIntencao
    OnStateChange = dsLancIntencoesStateChange
    Left = 544
    Top = 120
  end
