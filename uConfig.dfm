object fConfig: TfConfig
  ...
  Caption = 'fConfig - Configura'#231#227'o do Sistema'
  ClientHeight = 453
  ClientWidth = 982
  Color = clBtnFace
  ...
  object ibModulos: TIBQuery
    ...
    Left = 672
    Top = 8
    object ibModulosCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'MODULOS.CODIGO'
      Required = True
    end
    object ibModulosNOME: TIBStringField
      FieldName = 'NOME'
      Origin = 'MODULOS.NOME'
      Size = 60
    end
