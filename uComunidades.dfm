object fComunidades: TfComunidades
  Left = 192
  Top = 110
  Align = alCustom
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'fComunidades-CADASTRO DE COMUNIDADES'
  ClientHeight = 256
  ClientWidth = 686
  Color = clBtnFace
  ...
  object DsComunidade: TDataSource
    DataSet = DM1.TComunidade
    OnStateChange = DsComunidadeStateChange
    Left = 592
    Top = 48
  end
end
